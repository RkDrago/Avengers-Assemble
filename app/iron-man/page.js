            ...
            <div className="relative">
                ...
                <div className="bg-[#111] py-[25svh]">
                    <div className="min-h-[150svh] md:w-[80svw] w-[95svw] mx-auto rounded-[4rem] border-double border-8 text-center md:p-24 p-6 flex flex-col gap-14 relative avengers-page text-[#111] border-[#111]">
                        <div
                            className="md:w-[3rem] w-[10rem] md:h-[3rem] h-[10rem] bg-green-500 border-double border-4 border-[#4CAF50] rounded-full bg-[url(/imgs/ironman.jpg)] bg-cover absolute md:top-[27.5%] -top-36 md:left-[108.8%] left-[calc(50%-5rem)] md:avenger-img md:block"
                        ></div>
