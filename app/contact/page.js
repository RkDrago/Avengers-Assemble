                        ...
                        <div className="container w-[50%]">
                            <form className="contact-form flex flex-col gap-3 relative">
                                <div className="form-group flex flex-col gap-1 z-10">
                                    ...
                                    <input className='bg-[#98e38e8a] focus:bg-[#98e38eaa] text-black font-bold rounded h-[2rem] px-2 placeholder-[#11111173]' type="text" id="name" placeholder='Enter your full name' name="name" required />
                                </div>
                                <div className="form-group flex flex-col gap-1 z-10">
                                    <label className='font-bold pl-1' htmlFor="email">Email:</label>
                                    <input className='bg-[#98e38e8a] focus:bg-[#98e38eaa] text-black font-bold rounded h-[2rem] px-2 placeholder-[#11111173]' type="email" id="email" placeholder='Enter your email address' name="email" required />
                                </div>
                                <div className="form-group flex flex-col gap-1 z-10">
                                    <label className='font-bold pl-1' htmlFor="message">Message:</label>
                                    <textarea className='bg-[#98e38e8a] focus:bg-[#98e38eaa] text-black font-bold rounded min-h-[4rem] h-[4rem] max-h-[8rem] px-2 placeholder-[#11111173]' id="message" placeholder='Write your message here...' name="message" rows="5" required></textarea>
                                </div>
                                <button type="submit" className="submit-button absolute -right-[5rem] bottom-0 bg-[#98e38e8a] hover:bg-[#98e38eaa] rounded-full h-[4rem] w-[4rem] flex justify-center items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#111" fill="none">
